      ...
      >
        <div className="flex items-center justify-between border-b border-slate-800 px-6 py-4">
          <div>
            ...
            <p className="mt-1 text-xs text-slate-500">Add new infrastructure equipment</p>
          </div>
          <button onClick={onClose} className="text-slate-500 transition hover:text-white cursor-pointer">
            <X size={20} />
          </button>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          <div className="space-y-5 px-6 py-5">
            ...
            <div>
              <label className="mb-2 block text-sm text-slate-400">Device name</label>
              <input
                type="text"
            ...
            <div>
              <label className="mb-2 block text-sm text-slate-400">Device type</label>
              <select
                value={type}
            ...
            <div>
              ...
              >
                ...
                {locations.map(loc => (
                  <option key={loc.id} value={loc.id}>{loc.site} — {loc.building}</option>
                ))}
              </select>
            </div>

            <div>
              <label className="mb-2 block text-sm text-slate-400">IP Address</label>
              <input
                type="text"
