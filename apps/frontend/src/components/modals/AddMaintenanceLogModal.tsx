...
export default function AddMaintenance({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await createMaintenanceLog(deviceId, {
        workType,
        workResult,
      ...
      console.error(error);
      setLocalError("Failed to create maintenance record");
    } finally {
      setIsLoading(false);
    }
  };
        ...
        >
          <div>
            ...
            <p className="mt-1 text-xs text-slate-500">
              Add service or maintenance record
            </p>
          </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          >
            ...
            <button
              ...
              "
            >
              {isLoading ? "Creating..." : "Add Maintenance"}
            </button>
          </div>
        </form>
      </div>
