...
import {
  ...
  getLogsByDeviceController,
  getAllLogsController,
} from "./maintenance_contrloller";
import {
  createMaintenceLogSchema,
  updateMaintenceLogSchema,
...
export const logRoutes = async (fastify: FastifyInstance) => {
  fastify.post(
    "/devices/:deviceId/maintenance-logs",
    {
      preHandler: [
        authenticate as any,
        async (
          request: FastifyRequest<{ Body: CreateMaintenceLogDTO }>,
          reply,
        ) => {
  ...
  fastify.get(
    ...
    getLogsByDeviceController as any,
  );
  fastify.get(
    "/maintenance-logs",
    { preHandler: [authenticate] },
  ...
  fastify.patch(
    "/maintenance-logs/:id",
    {
      preHandler: [
        authenticate,
        async (
          request: FastifyRequest<{ Body: UpdateMaintenceLogDTO }>,
          reply,
        ) => {
