...
import {
  uploadDevicePhotoController,
  deletePhotoDeviceController,
} from "./photo_device_controller";
...
export const deviceRoutes = async (fastify: FastifyInstance) => {
  ...
  fastify.get(
    ...
    getDeviceByIdController as any,
  );
  fastify.patch(
    "/:id",
    {
  ...
  fastify.delete(
    "/:id",
    { preHandler: [authenticate] },
    deleteDeviceController as any,
  );
  fastify.post(
    "/:id/photos",
    { preHandler: [authenticate] },
    uploadDevicePhotoController as any,
  );
  fastify.delete(
    "/:id/photos/:photoId",
    { preHandler: [authenticate] },
    deletePhotoDeviceController as any,
  );
};
